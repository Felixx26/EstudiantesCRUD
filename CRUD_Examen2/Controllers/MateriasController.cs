...
namespace CRUD_Examen2.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(SistemaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var materia = await _context.Materia
                .FirstOrDefaultAsync(m => m.materia_id == id);
            if (materia == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("materia_id,codigo,nombre_materia,creditos")] Materia materia)
        {
        ...
        {
            return _context.Materia.Any(e => e.materia_id == id);
        }
    }
}
